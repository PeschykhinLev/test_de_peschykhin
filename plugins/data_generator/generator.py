...
# def generate_insert_order_data(batch_size: int) -> None:
...
#         logging.info(f"Successfully inserted {batch_size} records into orders table")

#     except Exception as e:
#         logging.error(f"Error in generate_insert_order_data: {str(e)}")
#         raise AirflowException(f"Failed to generate and insert order data: {str(e)}")
